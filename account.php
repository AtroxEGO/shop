...
<header>
        ...
        <div class="accountInfo">
            ...
            if($logged_in){
                ...
                ?>
                <h2 onClick="nameClick()" class="nameText">Hello, <?php echo $_SESSION['user_name']; ?></h2>
    ...
    <div class="ownedContainer">
        <div class="ownedTop">
            <div class="ownedText">Your NFT's:</div>
        ...
        <div class="ownedTileContainer">
            <?php
        $sql = "SELECT * FROM owned WHERE owner_id=$userID";
        $result = mysqli_query($conn, $sql);
        if(mysqli_num_rows($result) === 0){
            echo "<div class='noBitches'>NO BITCHES?</div>";
        }else{
        ...
        <div class='ownedItemName' ownedid='$owned_id'>$owned_name</div>
        <div class='ownedItemPrice'><span class='itemPriceValue'>$owned_price</span><img class='eth-symbol' src='assets/eth-white.png'></div>
        <div class='deleteButton' onClick='deleteOwned(this)'><span class="material-symbols-outlined">delete</span></div>
